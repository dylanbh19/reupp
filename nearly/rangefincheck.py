...
CFG = {
    ...
    "output_dir": "dist_input_ranges_advanced_local_econ_included",
    # --- CHANGED: Define the path to your local economic data CSV ---
    "econ_data_path": "economic_data_for_model.csv",
...
def predict_from_mail_input(models, mail_inputs, date_str=None):
    ...
    predict_date_floor = pd.to_datetime(predict_date).normalize()
